...
HD_PWD='C:/Users/qkoenin/Desktop/Lab2DLD/Lab2/Vivado/Lab1/Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_demo.tcl
